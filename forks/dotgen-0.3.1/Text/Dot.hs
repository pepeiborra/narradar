...
showAttr (name,val) = name ++ "="   ++ showEscString val ""

showEscString ('\\':'N':rest) = ("\\N" ++) . showEscString rest
showEscString ('\\':'G':rest) = ("\\G" ++) . showEscString rest
showEscString ('\\':'E':rest) = ("\\E" ++) . showEscString rest
showEscString ('\\':'T':rest) = ("\\T" ++) . showEscString rest
showEscString ('\\':'H':rest) = ("\\H" ++) . showEscString rest
showEscString ('\\':'L':rest) = ("\\L" ++) . showEscString rest
showEscString ('\\':'n':rest) = ("\\n" ++) . showEscString rest
showEscString ('\\':'l':rest) = ("\\l" ++) . showEscString rest
showEscString ('\\':'r':rest) = ("\\r" ++) . showEscString rest
showEscString (x:rest)        = showLitChar x . showEscString rest
showEscString []              = ([] ++)
